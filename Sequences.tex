...
\noindent The following lemma was developed for the purpose of working around to repeat one subproof in the proof of the theorem 'ProdConv' twice. Surprisingly, the eprover takes a long time to apply this lemma, although the lemma itself is proved really quickly and every precondition is provided.
...
\noindent The next theorem is a bit degenerate since the apparently "simple" equations used in Rudin took much more activity when trying to prove it with Alice. 
We also tried to simplify this proof, but this was always at the cost of run-time - if it ran at all. 

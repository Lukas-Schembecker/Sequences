...
\begin{forthel}
	...
	$abs((a[n] + b[n]) - (x + y)) \dotequal abs((a[n] + b[n]) + ((-x) + (-y)))$ (by MinusRule1)
	...
	\begin{proof}
		...
		\begin{subproof}
			...
			\begin{subproof}
				...
				$((LeastUpper(a) - \epsilon) + \epsilon) - a[N] \dotequal (LeastUpper(a) + (-\epsilon + \epsilon)) - a[N]$ (by AssAdd)

...
\noindent This is the most extreme case of additional concretisation we have to provide the prover. The corresponding excerpt of Rudin's book shows how big the differences are in length.
...
\noindent In the last part we formalized the definitions of limsup and liminf as depicted in Rudin, but be skipped the theorem based on these definitions since the proof considers the cases $\pm \ \infty$ (which we do not allow in our implementation as we cannot freely extend the real numbers but $\pm \ \infty$) and the last case is trivial.
